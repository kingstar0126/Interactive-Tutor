              ...
              <div>
                <div className="flex flex-col items-start gap-2">
                  ...
                  <p className=" text-gray-700">
                    The label is used to identify your AI Bots. It's private and
                  ...
                  >
                    ...
                    <AccordionBody className="border-t border-[--site-main-modal-input-border-color]">
                      <div className="flex flex-col items-start gap-2 text-black">
                        ...
                        <p className=" text-gray-700">
                          How would you like your AI Bots to start
                          conversations?
                        </p>
                      </div>
                    </AccordionBody>
                  ...
                  >
                    ...
                    <AccordionBody className="border-t border-[--site-main-modal-input-border-color]">
                      <div className="flex flex-col items-start gap-2 text-black">
                        ...
                        ></textarea>
                        <p className=" text-gray-700">
                          The description is used to identify your AI Bots. It's
                ...
                <div className="flex flex-col items-start p-5 mt-6 rounded-md border border-[--site-main-modal-input-border-color]">
                  ...
                  >
                    ...
                    <AccordionBody className="border-t border-[--site-main-modal-input-border-color] gap-5 flex-col flex h-full">
                      <div className="flex flex-col items-start gap-2 text-black">
                        <label className=" text-base font-semibold">
                          How do you want your AI Bots to use your training
                          data?
                        </label>
                        <Select
                          placeholder="Hello friends! How can I help you today?"
                          ...
                          defaultValue={behaviorModelTheme.find(
                            (item) => item.label === behaviormodel
                          )}
                          options={behaviorModelTheme}
                        />
                        <p className=" text-gray-700">
                          The context Behaviour determines how the training data
                          you provide will be Utilised. It specifies the way in
                          which the AI Bots understands and responds to user
                      ...
                      <div className="flex flex-col items-start gap-2 text-black">
                        ...
                        ></textarea>
                        <p className=" text-gray-700">
                          The Behaviour prompt overrides our default Behaviour
                          of 'You are a helpful assistant' to provide a more
                          customised experience, allowing your AI Bots to act in
                          a manner that aligns with your specific requirements
                          and preferences.
                        </p>
                      </div>
                      <div className="flex flex-col items-start gap-2 text-black">
                        ...
                        <p className=" text-gray-700">
                          ...
                          result in more unpredictable and diverse outputs,
                          while a lower temperature value, such as 0.2, can
                          produce a more precise and specific output.
                        </p>
                      </div>
                    </AccordionBody>
                  </Accordion>
                  ...
                  {TutorThemes.map((item, index) => {
                    return (
                      <Button
                        ...
                        onClick={() => handleTutorSeleted(item, index)}
                        key={index}
                      >
                        <span
                ...
                <div className="mt-2 gap-2 flex-col flex border border-[--site-onboarding-primary-color] rounded-lg h-full relative">
                    ...
                    <div className="absolute right-[calc(50%-72px)] top-[calc(50%-72px)] ">
                      <div className="flex flex-col items-center justify-center w-full p-2">
                        ...
                        <span className="absolute">
                          <div className="flex">
                            <span className="h-full">generating</span>
                          </div>
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="px-5 py-5 gap-3 flex-col flex">
                    <span className="text-red-600 text-[12px]">
                      Can’t see a match, no problem. Just type in here what you
                      want the AI to do for you in as much detail as possible.
                    </span>
                    <textarea

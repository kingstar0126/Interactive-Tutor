        ...
        <div className="flex items-end justify-end md:mt-[27px] md:mb-[30px] md:pr-[44px] pr-9">
          {_chat && _chat.organization && (
            <div className="xl:flex flex-col items-start justify-center mr-2 p-2 bg-[--site-warning-text-color] rounded shadow-2xl hidden">
              <p>
                <span className="font-bold text-[14px]">Organisation ID: </span>
                      ...
                      <td className="px-4 py-3 font-semibold border text-ms">
                        <Button
                          onClick={() => {
                            ...
                            setUserTutorCount(item.tutors);
                            setRole(item.role);
                            setUserQueryCount(item.query);
                            setUserTrainCount(item.training_datas);
                            setUserWordCount(item.training_words);
                            setItem(item);
                            setOpen(true);
                          }}
                          variant="outlined"
                        ...
                        <Button
                          variant="outlined"
                          onClick={() => handleChange(item.id, item.status)}
            ...
            <div className="mr-4 flex flex-col gap-2">
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  name="email"
                  onChange={(e) => setUserTutorCount(e.target.value)}
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  name="email"
                  onChange={(e) => setUserQueryCount(e.target.value)}
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  name="email"
                  onChange={(e) => setUserTrainCount(e.target.value)}
              ...
              <div className="flex flex-col">
                ...
                <input
                  type="text"
                  name="email"
                  onChange={(e) => setUserWordCount(e.target.value)}
                  value={userWordCount}
                  className="w-full h-10 px-5 py-3 bg-transparent border-[--site-main-modal-input-border-color] border rounded-md placeholder:text-black/60 placeholder:opacity-50"
                />
              </div>

    ...
    <div className="w-full flex gap-2 justify-center items-center ">
      <div className="w-2/3 flex">
        <div className="flex flex-col w-1/2 relative items-center m-auto">
          <input
            className="border-[--site-chat-header-border] border bg-transparent pl-4 pr-6 py-2 rounded-md w-full"
          ...
          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 -translate-x-1">
            <RiDeleteBin6Line
              className="active:fill-[--site-error-text-color] fill-[--site-card-icon-color]"
        ...
        <div className="w-1/2 flex p-1 ml-2">
          {data ? (
            ...
            <Button
              className=" normal-case bg-[--site-main-pricing-color]"
              onClick={handleOk}
            >
              Invite
            </Button>

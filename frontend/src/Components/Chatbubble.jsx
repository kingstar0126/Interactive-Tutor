...
const Chatbubble = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        ...
        setChathistory([{ role: "ai", content: "How can I help you?" }]);
      })
  ...
  return (
    <div>
      ...
      >
        <div className="w-full h-full from-[--site-main-modal-from-color] bg-gradient-to-br border border-[--site-main-modal-input-border-color] border-x-0 p-4">
          <Scrollbars>

            ...
            >
              ...
              >
                <div className="w-full 2xl:w-1/2">
                  <BubbleItem title={"Bubble"} data={current_chat.bubble} />
                </div>
                <div className="w-full 2xl:w-1/2">
                  <NotificationBubble
                    title={"Notification"}
            ...
            >
              ...
              <div name="text" className="flex flex-col w-full gap-5">
                <div className="w-full">
                  <LogoBranding title={"Logo"} data={current_chat.chat_logo} />
                </div>
            ...
            >
              ...
              >
                <div className="w-full 2xl:w-1/3 h-full">
                  <UserMessage title={"User"} data={current_chat.chat_logo} />
                </div>
                <div className="w-full 2xl:w-1/3 h-full">
                  <AIMessage title={"AI"} data={current_chat.chat_logo} />
                </div>

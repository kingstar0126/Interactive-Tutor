        ...
        <table className="text-left table-fixed sm:w-full min-h-[20rem] w-full">
          ...
          <tbody>
            {tableData.map((data, index) => {
              const classes = "sm:py-2 sm:px-5 w-1/4 sm:w-auto pl-2 pb-2";

              return (
                <tr key={data["label"]} className="flex sm:grid sm:grid-cols-5">
                  <td
                    className={"sm:col-span-2 sm:py-2 sm:px-5 w-1/4 sm:w-auto "}
                  >
